...
<body class="antialiased bg-gray-100 text-gray-900 flex flex-col gap-4 min-h-screen relative">
        ...
        <div class="max-w-7xl w-full mx-auto flex justify-between items-center px-4 lg:px-0 py-2">
            ...
            <nav>
                <ul id="navbar" class="hidden gap-4 text-brand text-lg font-semibold md:flex lg:ml-50">
                    ...
                    <li>
                        <a href="{{ route('home') }}#services" data-anchor="#services" class="nav-link-item hover:underline underline-offset-8 decoration-2 px-4 py-2 rounded-lg transition duration-300">
                            Serviços
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('home') }}#about" data-anchor="#about" class="nav-link-item hover:underline underline-offset-8 decoration-2 px-4 py-2 rounded-lg transition duration-300">
                            Sobre nós
                        </a>
                    </li>
                    <!-- <li>
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const activeClasses = ["underline", "underline-offset-8", "decoration-2"];
